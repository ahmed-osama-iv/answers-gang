          ...
          <nav class="nav-wrapper   purple darken-4">
            <div class="container">
                <a class=" waves-effect waves-purple " href="">
                  ...
                  <span style="margin-left:10px ; font-size: 20px ; font-weight: bolder" class="gang"onclick="M.toast({html: 'Gang will serve Gang will be of service'})">Answers' Gang</span></a>
