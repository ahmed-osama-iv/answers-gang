...
@section('content')
        ...
        @foreach($qs as $o)
            ...
            <a href="write.html" ><div class="contet-question">{{$o->content}}</div>
              <div class="vote">
               ...
               <a href="/answers/edit/{{$o->id}}" class="btn btn-primary">edit</a>
            <a href="/answers/delete/{{$o->id}}" class="btn btn-danger">delete</a>
            @endcan
              </span>
             </div>
  ...
  <div id="modal1" class="modal">
    ...
    <div id="modal2" class="modal">
        <div class="modal-content">
          <h2 style="text-align: center">You caaan post your Question here</h2>
          <div class="container">
